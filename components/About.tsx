      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="relative min-h-[600px] bg-white/5 border border-white/10 md:border-white/5 rounded-2xl p-4 md:p-6 lg:p-10 backdrop-blur-sm shadow-xl md:shadow-none hover:bg-white/[0.07] transition-colors duration-500">
